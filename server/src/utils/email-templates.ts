export const buildWelcomeHtml = (setupUrl: string, email: string): string => `
<!DOCTYPE html>
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:10px;">
                    <tr>
                      <td class="icon-td" style="width:36px;height:36px;min-width:36px;max-width:36px;background-color:#fdefd8;border:1px solid #e8c882;border-radius:6px;text-align:center;vertical-align:middle;line-height:0;overflow:hidden;">
                        <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACQAAAAkCAIAAABuYg/PAAAAR0lEQVR4nGP4+/4G3RDDqGWjlo1aNuwtO5TGRRU0ahn9LBu+qZGulg3fBDJ8LRu+qZGullEeN6OW0dsyuiaQUctGLRsJlgEAmchu9Txz3X4AAAAASUVORK5CYII=" width="36" height="36" alt="Menu and dishes icon" class="icon-img" style="display:block;border:0;outline:0;width:36px;height:36px;">
                      </td>
                    </tr>
                  </table>
              ...
              <tr>
                <td class="ci" style="padding:12px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:10px;">
                    <tr>
                      <td class="icon-td" style="width:36px;height:36px;min-width:36px;max-width:36px;background-color:#fdefd8;border:1px solid #e8c882;border-radius:6px;text-align:center;vertical-align:middle;line-height:0;overflow:hidden;">
                        <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACQAAAAkCAIAAABuYg/PAAAAcUlEQVR4nGP4+/4G3RDDqGVUt+xQGhfV0WCyDH9Q4DIIl0rCluFxJh4uVqlRy0YtG7VswDM1ddFQswx/AOJCA20Z8dGOaT1+B5GZ9Ecto6Jl1Ekgg9Ey/MGI6ayRZhkeRGXLiEH4nTL4LKM1GrWMKggAYJuLLxRMQR8AAAAASUVORK5CYII=" width="36" height="36" alt="QR code generator icon" class="icon-img" style="display:block;border:0;outline:0;width:36px;height:36px;">
                      </td>
                    </tr>
                  </table>
              ...
              <tr>
                <td class="ci" style="padding:12px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:10px;">
                    <tr>
                      <td class="icon-td" style="width:36px;height:36px;min-width:36px;max-width:36px;background-color:#fdefd8;border:1px solid #e8c882;border-radius:6px;text-align:center;vertical-align:middle;line-height:0;overflow:hidden;">
                        <img src="data:image/png;base64," width="36" height="36" alt="Team management icon" class="icon-img" style="display:block;border:0;outline:0;width:36px;height:36px;">
                      </td>
                    </tr>
                  </table>
              ...
              <tr>
                <td class="ci" style="padding:12px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:10px;">
                    <tr>
                      <td class="icon-td" style="width:36px;height:36px;min-width:36px;max-width:36px;background-color:#fdefd8;border:1px solid #e8c882;border-radius:6px;text-align:center;vertical-align:middle;line-height:0;overflow:hidden;">
                        <img src="data:image/png;base64," width="36" height="36" alt="3D augmented reality icon" class="icon-img" style="display:block;border:0;outline:0;width:36px;height:36px;">
                      </td>
                    </tr>
                  </table>
